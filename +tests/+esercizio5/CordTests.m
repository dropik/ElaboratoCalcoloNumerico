classdef CordTests < tests.esercizio5.WithMaxitTestCase
    ...
    properties(Access = protected)
        g = @(x) 6 * cos(3 * x);
        assertToleranceAmount = 1e-11;
    end

    methods(Access = protected)
        function [result, iterations] = findRoot(testCase, input)
            [result, iterations] = esercizio5.cord(...
                testCase.f, ...
                testCase.g, ...
                input, ...
    ...
    methods(Test, ParameterCombination = 'sequential')
        function testX0NonNumeric(testCase)
            testCase.assertError(...
                @() esercizio5.cord(testCase.f, testCase.g, '1', testCase.inputTolerance, testCase.inputMaxit), ...
        ...
        function testToleranceNonNumeric(testCase)
            testCase.assertError(...
                @() esercizio5.cord(testCase.f, testCase.g, 1, '1e-3', testCase.inputMaxit), ...
        ...
        function testToleranceEqualToZero(testCase)
            testCase.assertError(...
                @() esercizio5.cord(testCase.f, testCase.g, 1, 0, testCase.inputMaxit), ...
                'inputs:ToleranceMustBePositive' ...
            );
        end
        ...
        function testMaxitNonNumeric(testCase)
            testCase.assertError(...
                @() esercizio5.cord(testCase.f, testCase.g, 1, testCase.inputTolerance, '100'), ...
        ...
        function testMaxitEqualToZero(testCase)
            testCase.assertError(...
                @() esercizio5.cord(testCase.f, testCase.g, 1, testCase.inputTolerance, 0), ...
