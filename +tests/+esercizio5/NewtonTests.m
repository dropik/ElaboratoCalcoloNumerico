    ...
    methods(Test, ParameterCombination = 'sequential')
        function testX0NonNumeric(testCase)
            testCase.assertError(...
                @() esercizio5.newton(testCase.f, testCase.g, '1', testCase.inputTolerance, testCase.inputMaxit), ...
        ...
        function testToleranceNonNumeric(testCase)
            testCase.assertError(...
                @() esercizio5.newton(testCase.f, testCase.g, 1, '1e-3', testCase.inputMaxit), ...
        ...
        function testToleranceEqualToZero(testCase)
            testCase.assertError(...
                @() esercizio5.newton(testCase.f, testCase.g, 1, 0, testCase.inputMaxit), ...
                'inputs:ToleranceMustBePositive' ...
            );
        end
        ...
        function testMaxitNonNumeric(testCase)
            testCase.assertError(...
                @() esercizio5.newton(testCase.f, testCase.g, 1, testCase.inputTolerance, '100'), ...
        ...
        function testMaxitEqualToZero(testCase)
            testCase.assertError(...
                @() esercizio5.newton(testCase.f, testCase.g, 1, testCase.inputTolerance, 0), ...
